"""
高级优化的食物识别训练脚本 - 目标准确率90%+

主要改进：
1. 使用EfficientNet-B0作为backbone（更轻量但性能更好）
2. 渐进式解冻训练策略
3. 标签平滑
4. 更好的数据增强
5. 学习率预热
...
def seed_everything(seed):
    ...
    torch.backends.cudnn.benchmark = True  # 启用benchmark以提高性能
...
def main():
    ...
    # 创建高级模型
    model = EfficientNetB0_CBAM(num_classes=11)
